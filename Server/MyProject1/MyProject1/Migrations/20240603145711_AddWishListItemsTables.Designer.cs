...
namespace MyProject1.Migrations
{
    ...
    [Migration("20240603145711_AddWishListItemsTables")]
    partial class AddWishListItemsTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyProject.Models.RealStates.Compound", b =>
                {
                    ...
                    b.Property<int>("RealEstateConut")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject1.Models.Lists.WishListItem", b =>
                {
                    b.Property<int>("WishListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject1.Models.RealStates.CompoundImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CompoundImages");
                });

            modelBuilder.Entity("MyProject1.Models.RealStates.Developer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyProject.Models.RealStates.Compound", b =>
                {
                    b.HasOne("MyProject1.Models.RealStates.Developer", "Developer")
                        .WithMany("compounds")
            ...
            modelBuilder.Entity("MyProject1.Models.Lists.WishListItem", b =>
                {
                    ...
                    b.HasOne("MyProject.Models.Lists.WishList", "WishList")
                        .WithMany("WishListItems")
